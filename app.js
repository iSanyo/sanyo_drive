...
// 在head 中 加载 必要静态
document.write(
  '<link rel="stylesheet" href="//cdn.jsdelivr.net/gh/iSanyo/sanyo_drive/css/mdui.min.css">'
);
document.write(
  '<link rel="stylesheet" href="//cdn.jsdelivr.net/gh/iSanyo/sanyo_drive/css/nexmoe.min.css">'
);
// markdown支持
document.write(
  '<script src="//cdn.jsdelivr.net/gh/iSanyo/sanyo_drive/js/markdown-it.min.js"></script>'
);
document.write(
...
document.write(
  '<link rel="stylesheet" href="//cdn.jsdelivr.net/gh/iSanyo/sanyo_drive/css/DPlayer.min.css">'
);
document.write(
  '<script src="//cdn.jsdelivr.net/gh/iSanyo/sanyo_drive/js/DPlayer.min.js"></script>'
);
document.write(
  '<script src="//cdn.jsdelivr.net/gh/iSanyo/sanyo_drive/js/hls.min.js"></script>'
);
document.write(
  '<script src="//cdn.jsdelivr.net/gh/iSanyo/sanyo_drive/js/flv.min.js"></script>'
);
...
<header class="nexmoe-nav">
    <div class="navSize">
			...
			<div class="nav_menu">
				<ul class="menu_ul">
					<li class="menu_li"><a href="https://iSanyo.github.io/" target="_blank">博客</a></li>

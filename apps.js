 ...
 */
// 在head 中 加载 必要静态
document.write('<link rel="stylesheet" href="//cdn.jsdelivr.net/gh/iSanyo/sanyo_drive/css/mdui.css">');
document.write('<link rel="icon" href="//cdn.jsdelivr.net/gh/iSanyo/sanyo_drive/imgs/favicon.ico">');
document.write('<link rel="stylesheet" href="//cdn.jsdelivr.net/gh/iSanyo/sanyo_drive/css/nexmoe.css">');
document.write('<script src="//cdn.jsdelivr.net/gh/iSanyo/sanyo_drive/js/mdui.min.js"></script>');
document.write('<script src="//cdn.jsdelivr.net/gh/iSanyo/sanyo_drive/js/flv.min.js"></script>');
document.write('<script src="//cdn.jsdelivr.net/gh/iSanyo/sanyo_drive/js/DPlayer.min.js"></script>');
// markdown支持
document.write('<script src="//cdn.jsdelivr.net/gh/iSanyo/sanyo_drive/js/markdown-it.min.js"></script>');
document.write('<style>.mdui-appbar .mdui-toolbar{height:56px;font-size:1pc}.mdui-toolbar>i{opacity:.5}.mdui-toolbar>i{padding:0}.mdui-toolbar>a:hover,a.active,a.mdui-typo-headline{opacity:1}.mdui-container{max-width:1020px}.mdui-list-item{transition:none}.mdui-list>.th{background-color:initial}.mdui-list-item>a{width:100%;line-height:3pc}.mdui-list-item{margin:2px 0;padding:0}.mdui-toolbar>a:last-child{opacity:1}@media screen and (max-width:980px){.mdui-list-item .mdui-text-right{display:none}.mdui-container{width:100%!important;margin:0}}</style>');
...
<header class="nexmoe-nav">
	<div class="navSize">
			<a href="/"><img class="avatar" src="http://cdn.jsdelivr.net/gh/iSanyo/sanyo_drive/imgs/avatar.jpg"/></a>
			<div class="nav_menu">
				<ul class="menu_ul">
					<li class="menu_li"><a href="http://www.8388888.xyz/" target="_blank">博客</a></li>
					<li class="menu_li"><a href="http://www.workers.dev/" target="_blank">管理</a></li>
...
function nav(path) {
  ...
  var search_bar = `<div class="mdui-toolbar-spacer"></div>
        <div id="search_bar" class="mdui-textfield mdui-textfield-expandable mdui-float-right ${model.is_search_page ? 'mdui-textfield-expanded' : ''}" style="max-width:${isMobile ? 233 : 355}px">
...
<script src="//cdn.jsdelivr.net/gh/iSanyo/sanyo_drive/js/ace.js"></script>
<script src="//cdn.jsdelivr.net/gh/iSanyo/sanyo_drive/js/ext-language_tools.js"></script>
	`;
  $('#content').html(content);
...
function file_video(path) {
  ...
  let player_items = [
    ...
    {
      text: '网页播放',
      href: `//www.nuocom.cn/dplayer/?url=${url}`
    }
  ]
  ...
  const playBtn = `
      <button class="mdui-btn mdui-ripple mdui-color-theme-accent" mdui-menu="{target:'#player-items'}">
        <i class="mdui-icon material-icons">&#xe039;</i>外部播放<i class="mdui-icon material-icons">&#xe5cf;</i>
      </button>
...
<div class="mdui-container-fluid">
	...
	<div class="mdui-textfield">
	  ...
	  <input class="mdui-textfield-input" type="text" value="<video><source src='${url}' type='video/mp4'></video>"/>
	</div>
</div>
